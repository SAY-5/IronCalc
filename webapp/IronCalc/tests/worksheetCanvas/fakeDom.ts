...
// Fixed values so screenshots never depend on the real CSS. "TestFont" is
// the bundled DejaVu Sans registered by the harness, so text rendering is
// identical on every machine.
export const testThemeVars: Record<string, string> = {
  "--palette-common-white": "#ffffff",
  "--palette-sheet-grid-color": "#dcdcdc",
  "--palette-sheet-default-cell-font-family": "TestFont",
  ...
  "--palette-sheet-header-font": "12px TestFont",
